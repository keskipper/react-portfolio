...
class Blog extends Component {
        ...
        .then(response => {
            this.setState({
                blogItems: this.state.blogItems.filter(blogItem => {
                    ...
                    //only return blog items that are not the current one
                })
            })
    ...
    getBlogItems() {
        ...
        axios.get(`https://katherineskipper.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { withCredentials: true 
        }).then(response => {
